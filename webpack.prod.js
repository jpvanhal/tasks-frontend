...
const { StaticAssetPlugin } = require('@angular/cli/plugins/static-asset');
...
module.exports = {
  ...
  "module": {
    "rules": [
      ...
      {
        "exclude": [
          path.join(process.cwd(), "node_modules/material-design-icons-iconfont/dist/material-design-icons.css"),
